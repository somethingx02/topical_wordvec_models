...
if __name__ == '__main__':
    ...
    fptInWS353 = open('../datasets/SCWSratings.txt',
                      'rt',
                      encoding='utf8')
    fptOutWS353vocad = open('../datasets/SCWSratings_vocad.txt', 'wt',
                            encoding='utf8')
    for aline in fptInWS353:
        aline = aline.strip().lower()
        (linenum, word1, pos1, word2, pos2, word1context,
         word2context, score, others) = aline.split('\t', 8)
